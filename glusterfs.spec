...
# rpmbuild -ta glusterfs-2.0.0qa17.tar.gz --without modglfs
...
# rpmbuild -ta glusterfs-2.0.0qa17.tar.gz --without apxs_default --define 'apxs_path /usr/local/apache/bin' 
...
# rpmbuild -ta glusterfs-2.0.0qa17.tar.gz --without apache_auto -define 'apxs_bin_path /usr/local/apache/bin/apxs'
# rpmbuild -ta glusterfs-2.0.0qa17.tar.gz --without apache_auto -define 'apache_bin_path /usr/local/apache/bin/apache2'
...
BuildRequires: gcc
BuildRequires: make
URL: ftp://ftp.zresearch.com/pub/gluster/glusterfs/1.4-qa/glusterfs-2.0.0qa17.tar.gz
